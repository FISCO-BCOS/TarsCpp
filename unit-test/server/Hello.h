...
inline std::stringetos(const EN_KEY &e) {
  switch (e) {
  case KEY1:
    return "KEY1";
  case KEY2:
...
inline int stoe(const std::string &s, EN_KEY &e) {
  if (s == "KEY1") {
    e = KEY1;
    return 0;
  }
...
public:
  static std::stringclassName() { return "Test.JsonKey"; }
  static std::stringMD5() { return "7b010a6336d210a506b1eb4bf4c1e014"; }
  JsonKey() { resetDefautlt(); }
  void resetDefautlt() { i = 0; }
  ...
  std::stringwriteToJsonString() const {
...
inline bool operator!=(const JsonKey &l, const JsonKey &r) { return !(l == r); }
inline std::ostream &operator<<(ostream &os, const JsonKey &r) {
...
inline bool operator<=(const JsonKey &l, const JsonKey &r) { return !(r < l); }
inline bool operator>(const JsonKey &l, const JsonKey &r) { return r < l; }
inline bool operator>=(const JsonKey &l, const JsonKey &r) { return !(l < r); }

struct JsonData : public tars::TarsStructBase {
public:
  static std::stringclassName() { return "Test.JsonData"; }
  static std::stringMD5() { return "7e2b4e48c7c69de6efedb26120c23c90"; }
  JsonData() { resetDefautlt(); }
  void resetDefautlt() {
    c = 0;
    s = 0;
    i = 0;
...
public:
  ...
  Test::EN_KEY k;
  std::string ss;
  std::map<Test::EN_KEY, std::string> data;
  std::vector<Test::EN_KEY> v;
  std::map<tars::Int32, std::string> im;
  std::map<tars::Bool, std::string> bm;
  std::map<tars::Float, std::string> fm;
  std::vector<tars::Bool> bv;
  std::vector<tars::Int32> iv;
  std::vector<tars::Double> dv;
};
inline bool operator==(const JsonData &l, const JsonData &r) {
  return l.c == r.c && l.s == r.s && l.i == r.i && l.l == r.l &&
         tars::TC_Common::equal(l.f, r.f) && tars::TC_Common::equal(l.d, r.d) &&
         l.uc == r.uc && l.us == r.us && l.ui == r.ui && l.b == r.b &&
         l.k == r.k && l.ss == r.ss && l.data == r.data && l.v == r.v &&
         l.im == r.im && l.bm == r.bm && tars::TC_Common::equal(l.fm, r.fm) &&
         l.bv == r.bv && l.iv == r.iv && tars::TC_Common::equal(l.dv, r.dv);
}
inline bool operator!=(const JsonData &l, const JsonData &r) {
  return !(l == r);
}
inline std::ostream &operator<<(ostream &os, const JsonData &r) {
  os << r.writeToJsonString();
  return os;
}
...
public:
  static std::stringclassName() { return "Test.JsonMap"; }
  static std::stringMD5() { return "5bf0437e83ccb7e533b35c9747197b50"; }
  JsonMap() { resetDefautlt(); }
  void resetDefautlt() { json.clear(); }
  template <typename WriterT>
  void writeTo(tars::TarsOutputStream<WriterT> &_os) const {
    if (json.size() > 0) {
      _os.write(json, 0);
...
public:
  std::map<Test::JsonKey, Test::JsonData> json;
};
inline bool operator==(const JsonMap &l, const JsonMap &r) {
  return l.json == r.json;
}
inline bool operator!=(const JsonMap &l, const JsonMap &r) { return !(l == r); }
inline std::ostream &operator<<(ostream &os, const JsonMap &r) {
  os << r.writeToJsonString();
  return os;
}
...
public:
  ...
  virtual void callback_testCoro_exception(tars::Int32 ret) {
    throw std::runtime_error(
        "callback_testCoro_exception() override incorrect.");
  }
  ...
  virtual void callback_testDyeingTrans_exception(tars::Int32 ret) {
    throw std::runtime_error(
        "callback_testDyeingTrans_exception() override incorrect.");
  }
  ...
  virtual void callback_testPid_exception(tars::Int32 ret) {
    throw std::runtime_error(
        "callback_testPid_exception() override incorrect.");
  }
  ...
  virtual void callback_testSyncTrans_exception(tars::Int32 ret) {
    throw std::runtime_error(
        "callback_testSyncTrans_exception() override incorrect.");
  }
  ...
  virtual void callback_testTimeout_exception(tars::Int32 ret) {
    throw std::runtime_error(
        "callback_testTimeout_exception() override incorrect.");
  }
  ...
  virtual void callback_testTrans_exception(tars::Int32 ret) {
    throw std::runtime_error(
        "callback_testTrans_exception() override incorrect.");
  }
...
public:
  virtual int onDispatch(tars::ReqMessagePtr msg) {
    static std::string __Hello_all[] = {
        "testCoro", "testDyeing",    "testDyeingTrans", "testHello",
        "testPid",  "testSyncTrans", "testTimeout",     "testTrans"};
    std::pair<string *, std::string *> r = equal_range(
        __Hello_all, __Hello_all + 8, string(msg->request.sFuncName));
    if (r.first == r.second)
    ...
    case 0: {
      ...
      if (pSptd && pSptd->_traceCall) {
        std::string_trace_param_;
        int _trace_param_flag_ = pSptd->needTraceParam(
            ServantProxyThreadData::TraceContext::EST_CR, _is.size());
        if (ServantProxyThreadData::TraceContext::ENP_NORMAL ==
            _trace_param_flag_) {
        ...
        } else if (ServantProxyThreadData::TraceContext::ENP_OVERMAXLEN ==
                   _trace_param_flag_) {
          _trace_param_ = "{\"trace_param_over_max_len\":true}";
        }
        TARS_TRACE(
            pSptd->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR),
            TRACE_ANNOTATION_CR, "",
            ServerConfig::Application + "." + ServerConfig::ServerName,
            "testCoro", 0, _trace_param_, "");
      }
    ...
    case 2: {
      ...
      if (pSptd && pSptd->_traceCall) {
        ...
        TARS_TRACE(
            ...
            TRACE_ANNOTATION_CR, "",
            ServerConfig::Application + "." + ServerConfig::ServerName,
            "testDyeingTrans", 0, _trace_param_, "");
      }
...
public:
  ...
  typedef tars::TC_AutoPtr<HelloPrxCallbackPromise::PromisetestCoro>
      PromisetestCoroPtr;

  HelloPrxCallbackPromise(
      const tars::Promise<HelloPrxCallbackPromise::PromisetestCoroPtr> &promise)
      : _promise_testCoro(promise) {}

  virtual void
  callback_testCoro(const HelloPrxCallbackPromise::PromisetestCoroPtr &ptr) {
...
public:
  ...
  typedef tars::TC_AutoPtr<HelloPrxCallbackPromise::PromisetestDyeing>
      PromisetestDyeingPtr;

  HelloPrxCallbackPromise(
      const tars::Promise<HelloPrxCallbackPromise::PromisetestDyeingPtr>
          &promise)
      : _promise_testDyeing(promise) {}

  virtual void callback_testDyeing(
      const HelloPrxCallbackPromise::PromisetestDyeingPtr &ptr) {
...
protected:
  tars::Promise<HelloPrxCallbackPromise::PromisetestDyeingPtr>
      _promise_testDyeing;
...
public:
  ...
  typedef tars::TC_AutoPtr<HelloPrxCallbackPromise::PromisetestDyeingTrans>
      PromisetestDyeingTransPtr;

  HelloPrxCallbackPromise(
      const tars::Promise<HelloPrxCallbackPromise::PromisetestDyeingTransPtr>
          &promise)
      : _promise_testDyeingTrans(promise) {}

  virtual void callback_testDyeingTrans(
      const HelloPrxCallbackPromise::PromisetestDyeingTransPtr &ptr) {
...
protected:
  tars::Promise<HelloPrxCallbackPromise::PromisetestDyeingTransPtr>
      _promise_testDyeingTrans;
...
public:
  ...
  typedef tars::TC_AutoPtr<HelloPrxCallbackPromise::PromisetestHello>
      PromisetestHelloPtr;

  HelloPrxCallbackPromise(
      const tars::Promise<HelloPrxCallbackPromise::PromisetestHelloPtr>
          &promise)
      : _promise_testHello(promise) {}

  virtual void
  callback_testHello(const HelloPrxCallbackPromise::PromisetestHelloPtr &ptr) {
...
protected:
  tars::Promise<HelloPrxCallbackPromise::PromisetestHelloPtr>
      _promise_testHello;
...
public:
  ...
  typedef tars::TC_AutoPtr<HelloPrxCallbackPromise::PromisetestPid>
      PromisetestPidPtr;

  HelloPrxCallbackPromise(
      const tars::Promise<HelloPrxCallbackPromise::PromisetestPidPtr> &promise)
      : _promise_testPid(promise) {}

  virtual void
  callback_testPid(const HelloPrxCallbackPromise::PromisetestPidPtr &ptr) {
...
public:
  ...
  typedef tars::TC_AutoPtr<HelloPrxCallbackPromise::PromisetestSyncTrans>
      PromisetestSyncTransPtr;

  HelloPrxCallbackPromise(
      const tars::Promise<HelloPrxCallbackPromise::PromisetestSyncTransPtr>
          &promise)
      : _promise_testSyncTrans(promise) {}

  virtual void callback_testSyncTrans(
      const HelloPrxCallbackPromise::PromisetestSyncTransPtr &ptr) {
...
protected:
  tars::Promise<HelloPrxCallbackPromise::PromisetestSyncTransPtr>
      _promise_testSyncTrans;
...
public:
  ...
  typedef tars::TC_AutoPtr<HelloPrxCallbackPromise::PromisetestTimeout>
      PromisetestTimeoutPtr;

  HelloPrxCallbackPromise(
      const tars::Promise<HelloPrxCallbackPromise::PromisetestTimeoutPtr>
          &promise)
      : _promise_testTimeout(promise) {}

  virtual void callback_testTimeout(
      const HelloPrxCallbackPromise::PromisetestTimeoutPtr &ptr) {
...
protected:
  tars::Promise<HelloPrxCallbackPromise::PromisetestTimeoutPtr>
      _promise_testTimeout;
...
public:
  ...
  typedef tars::TC_AutoPtr<HelloPrxCallbackPromise::PromisetestTrans>
      PromisetestTransPtr;

  HelloPrxCallbackPromise(
      const tars::Promise<HelloPrxCallbackPromise::PromisetestTransPtr>
          &promise)
      : _promise_testTrans(promise) {}

  virtual void
  callback_testTrans(const HelloPrxCallbackPromise::PromisetestTransPtr &ptr) {
...
protected:
  tars::Promise<HelloPrxCallbackPromise::PromisetestTransPtr>
      _promise_testTrans;
...
public:
  virtual int onDispatch(tars::ReqMessagePtr msg) {
    ...
    case 0: {
      ...
      HelloPrxCallbackPromise::PromisetestCoroPtr ptr =
          new HelloPrxCallbackPromise::PromisetestCoro();
    ...
    case 1: {
      ...
      HelloPrxCallbackPromise::PromisetestDyeingPtr ptr =
          new HelloPrxCallbackPromise::PromisetestDyeing();
    ...
    case 2: {
      ...
      HelloPrxCallbackPromise::PromisetestDyeingTransPtr ptr =
          new HelloPrxCallbackPromise::PromisetestDyeingTrans();
    ...
    case 3: {
      ...
      HelloPrxCallbackPromise::PromisetestHelloPtr ptr =
          new HelloPrxCallbackPromise::PromisetestHello();
    ...
    case 4: {
      ...
      HelloPrxCallbackPromise::PromisetestPidPtr ptr =
          new HelloPrxCallbackPromise::PromisetestPid();
    ...
    case 5: {
      ...
      HelloPrxCallbackPromise::PromisetestSyncTransPtr ptr =
          new HelloPrxCallbackPromise::PromisetestSyncTrans();
    ...
    case 6: {
      ...
      HelloPrxCallbackPromise::PromisetestTimeoutPtr ptr =
          new HelloPrxCallbackPromise::PromisetestTimeout();
    ...
    case 7: {
      ...
      HelloPrxCallbackPromise::PromisetestTransPtr ptr =
          new HelloPrxCallbackPromise::PromisetestTrans();
...
public:
  ...
  virtual void
  setResponseContext(const std::map<std::string, std::string> &mContext) {
...
public:
  typedef std::map<std::string, string> TARS_CONTEXT;
  tars::Bool
  testCoro(const std::string &sIn, std::string &sOut,
           const std::map<std::string, string> &context = TARS_CONTEXT(),
           std::map<std::string, string> *pResponseContext = NULL) {
    ...
    if (pSptd && pSptd->_traceCall) {
      ...
      std::string_trace_param_;
      int _trace_param_flag_ = pSptd->needTraceParam(
          ServantProxyThreadData::TraceContext::EST_CS, _os.getLength());
      if (ServantProxyThreadData::TraceContext::ENP_NORMAL ==
          _trace_param_flag_) {
        tars::JsonValueObjPtr _p_ = new tars::JsonValueObj();
      ...
      TARS_TRACE(
          pSptd->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS),
          TRACE_ANNOTATION_CS,
          ServerConfig::Application + "." + ServerConfig::ServerName,
          tars_name(), "testCoro", 0, _trace_param_, "");
    }

    std::map<std::string, string> _mStatus;
    std::shared_ptr<tars::ResponsePacket> rep =
        tars_invoke(tars::TARSNORMAL, "testCoro", _os, context, _mStatus);
    if (pResponseContext) {
  ...
  void async_testCoro(
      HelloPrxCallbackPtr callback, const std::string &sIn,
      const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(sIn, 1);
    std::map<std::string, string> _mStatus;
    ...
    tars_invoke_async(tars::TARSNORMAL, "testCoro", _os, context, _mStatus,
                      callback);
  }

  tars::Future<HelloPrxCallbackPromise::PromisetestCoroPtr>
  promise_async_testCoro(const std::string &sIn,
                         const std::map<std::string, string> &context) {
  ...
  void
  coro_testCoro(HelloCoroPrxCallbackPtr callback, const std::string &sIn,
                const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(sIn, 1);
    std::map<std::string, string> _mStatus;
  ...
  tars::Int32
  testDyeing(const std::string &strIn, std::string &strOut,
             const std::map<std::string, string> &context = TARS_CONTEXT(),
             std::map<std::string, string> *pResponseContext = NULL) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(strIn, 1);
    ...
    if (pSptd && pSptd->_traceCall) {
      ...
      TARS_TRACE(
          ...
          TRACE_ANNOTATION_CS,
          ServerConfig::Application + "." + ServerConfig::ServerName,
          tars_name(), "testDyeing", 0, _trace_param_, "");
    }
  ...
  void async_testDyeing(
      HelloPrxCallbackPtr callback, const std::string &strIn,
      const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(strIn, 1);
    std::map<std::string, string> _mStatus;
  ...
  tars::Future<HelloPrxCallbackPromise::PromisetestDyeingPtr>
  promise_async_testDyeing(const std::string &strIn,
                           const std::map<std::string, string> &context) {
  ...
  void coro_testDyeing(
      HelloCoroPrxCallbackPtr callback, const std::string &strIn,
      const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(strIn, 1);
    std::map<std::string, string> _mStatus;
  ...
  tars::Int32
  testDyeingTrans(const std::map<std::string, string> &context = TARS_CONTEXT(),
                  std::map<std::string, string> *pResponseContext = NULL) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    ServantProxyThreadData *pSptd = ServantProxyThreadData::getData();
    if (pSptd && pSptd->_traceCall) {
      ...
      TARS_TRACE(
          ...
          TRACE_ANNOTATION_CS,
          ServerConfig::Application + "." + ServerConfig::ServerName,
          tars_name(), "testDyeingTrans", 0, _trace_param_, "");
    }

    std::map<std::string, string> _mStatus;
    std::shared_ptr<tars::ResponsePacket> rep = tars_invoke(
        tars::TARSNORMAL, "testDyeingTrans", _os, context, _mStatus);
    if (pResponseContext) {
      pResponseContext->swap(rep->context);
    }
  ...
  void async_testDyeingTrans(
      HelloPrxCallbackPtr callback,
      const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    std::map<std::string, string> _mStatus;
    ServantProxyThreadData *pSptd = ServantProxyThreadData::getData();
    ...
    tars_invoke_async(tars::TARSNORMAL, "testDyeingTrans", _os, context,
                      _mStatus, callback);
  }

  tars::Future<HelloPrxCallbackPromise::PromisetestDyeingTransPtr>
  promise_async_testDyeingTrans(const std::map<std::string, string> &context) {
  ...
  void coro_testDyeingTrans(
      HelloCoroPrxCallbackPtr callback,
      const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    std::map<std::string, string> _mStatus;
    tars_invoke_async(tars::TARSNORMAL, "testDyeingTrans", _os, context,
  ...
  tars::Int32
  testHello(tars::Int32 index, const std::string &s, std::string &r,
            const std::map<std::string, string> &context = TARS_CONTEXT(),
            std::map<std::string, string> *pResponseContext = NULL) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(index, 1);
    ...
    if (pSptd && pSptd->_traceCall) {
      ...
      TARS_TRACE(
          ...
          TRACE_ANNOTATION_CS,
          ServerConfig::Application + "." + ServerConfig::ServerName,
          tars_name(), "testHello", 0, _trace_param_, "");
    }
  ...
  void async_testHello(
      HelloPrxCallbackPtr callback, tars::Int32 index, const std::string &s,
      const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(index, 1);
    _os.write(s, 2);
  ...
  tars::Future<HelloPrxCallbackPromise::PromisetestHelloPtr>
  promise_async_testHello(tars::Int32 index, const std::string &s,
                          const std::map<std::string, string> &context) {
  ...
  void coro_testHello(
      HelloCoroPrxCallbackPtr callback, tars::Int32 index, const std::string &s,
      const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(index, 1);
    _os.write(s, 2);
  ...
  testPid(std::string &r,
    ...
    if (pSptd && pSptd->_traceCall) {
      ...
      TARS_TRACE(
          ...
          TRACE_ANNOTATION_CS,
          ServerConfig::Application + "." + ServerConfig::ServerName,
          tars_name(), "testPid", 0, _trace_param_, "");
    }

    std::map<std::string, string> _mStatus;
    std::shared_ptr<tars::ResponsePacket> rep =
        tars_invoke(tars::TARSNORMAL, "testPid", _os, context, _mStatus);
    if (pResponseContext) {
      pResponseContext->swap(rep->context);
    }
  ...
  void
  async_testPid(HelloPrxCallbackPtr callback,
                const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    std::map<std::string, string> _mStatus;
    ServantProxyThreadData *pSptd = ServantProxyThreadData::getData();
    ...
    tars_invoke_async(tars::TARSNORMAL, "testPid", _os, context, _mStatus,
                      callback);
  }

  tars::Future<HelloPrxCallbackPromise::PromisetestPidPtr>
  promise_async_testPid(const std::map<std::string, string> &context) {
  ...
  void
  coro_testPid(HelloCoroPrxCallbackPtr callback,
               const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    std::map<std::string, string> _mStatus;
    tars_invoke_async(tars::TARSNORMAL, "testPid", _os, context, _mStatus,
  ...
  tars::Int32
  testSyncTrans(tars::Int32 index, const std::string &s, std::string &r,
                const std::map<std::string, string> &context = TARS_CONTEXT(),
                std::map<std::string, string> *pResponseContext = NULL) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(index, 1);
    ...
    if (pSptd && pSptd->_traceCall) {
      ...
      TARS_TRACE(
          ...
          TRACE_ANNOTATION_CS,
          ServerConfig::Application + "." + ServerConfig::ServerName,
          tars_name(), "testSyncTrans", 0, _trace_param_, "");
    }

    std::map<std::string, string> _mStatus;
    std::shared_ptr<tars::ResponsePacket> rep =
        tars_invoke(tars::TARSNORMAL, "testSyncTrans", _os, context, _mStatus);
    if (pResponseContext) {
      pResponseContext->swap(rep->context);
    }
  ...
  void async_testSyncTrans(
    ...
    tars_invoke_async(tars::TARSNORMAL, "testSyncTrans", _os, context, _mStatus,
                      callback);
  }

  tars::Future<HelloPrxCallbackPromise::PromisetestSyncTransPtr>
  promise_async_testSyncTrans(tars::Int32 index, const std::string &s,
                              const std::map<std::string, string> &context) {
  ...
  tars::Int32
  testTimeout(tars::Int32 timeout,
              const std::map<std::string, string> &context = TARS_CONTEXT(),
              std::map<std::string, string> *pResponseContext = NULL) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(timeout, 1);
    ...
    if (pSptd && pSptd->_traceCall) {
      ...
      TARS_TRACE(
          ...
          TRACE_ANNOTATION_CS,
          ServerConfig::Application + "." + ServerConfig::ServerName,
          tars_name(), "testTimeout", 0, _trace_param_, "");
    }

    std::map<std::string, string> _mStatus;
    std::shared_ptr<tars::ResponsePacket> rep =
        tars_invoke(tars::TARSNORMAL, "testTimeout", _os, context, _mStatus);
    if (pResponseContext) {
      pResponseContext->swap(rep->context);
    }
  ...
  void async_testTimeout(
      HelloPrxCallbackPtr callback, tars::Int32 timeout,
      const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(timeout, 1);
    std::map<std::string, string> _mStatus;
    ...
    tars_invoke_async(tars::TARSNORMAL, "testTimeout", _os, context, _mStatus,
                      callback);
  }

  tars::Future<HelloPrxCallbackPromise::PromisetestTimeoutPtr>
  promise_async_testTimeout(tars::Int32 timeout,
                            const std::map<std::string, string> &context) {
  ...
  void coro_testTimeout(
      HelloCoroPrxCallbackPtr callback, tars::Int32 timeout,
      const std::map<std::string, string> &context = TARS_CONTEXT()) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(timeout, 1);
    std::map<std::string, string> _mStatus;
  ...
  tars::Int32
  testTrans(tars::Int32 index, const std::string &s, std::string &r,
            const std::map<std::string, string> &context = TARS_CONTEXT(),
            std::map<std::string, string> *pResponseContext = NULL) {
    tars::TarsOutputStream<tars::BufferWriterVector> _os;
    _os.write(index, 1);
    ...
    if (pSptd && pSptd->_traceCall) {
      ...
      TARS_TRACE(
          ...
          TRACE_ANNOTATION_CS,
          ServerConfig::Application + "." + ServerConfig::ServerName,
          tars_name(), "testTrans", 0, _trace_param_, "");
    }

    std::map<std::string, string> _mStatus;
    std::shared_ptr<tars::ResponsePacket> rep =
        tars_invoke(tars::TARSNORMAL, "testTrans", _os, context, _mStatus);
    if (pResponseContext) {
      pResponseContext->swap(rep->context);
    }
  ...
  void async_testTrans(
    ...
    tars_invoke_async(tars::TARSNORMAL, "testTrans", _os, context, _mStatus,
                      callback);
  }

  tars::Future<HelloPrxCallbackPromise::PromisetestTransPtr>
  promise_async_testTrans(tars::Int32 index, const std::string &s,
                          const std::map<std::string, string> &context) {
...
public:
  virtual ~Hello() {}
  virtual tars::Bool testCoro(const std::string &sIn, std::string &sOut,
                              tars::TarsCurrentPtr current) = 0;
  static void async_response_testCoro(tars::TarsCurrentPtr current,
                                      tars::Bool _ret,
    ...
    if (current->isTraced()) {
      std::string_trace_param_;
      int _trace_param_flag_ = ServantProxyThreadData::needTraceParam(
          ServantProxyThreadData::TraceContext::EST_SS, current->getTraceKey(),
          _rsp_len_);
      if (ServantProxyThreadData::TraceContext::ENP_NORMAL ==
          _trace_param_flag_) {
        tars::JsonValueObjPtr _p_ = new tars::JsonValueObj();
      ...
      TARS_TRACE(current->getTraceKey(), TRACE_ANNOTATION_SS, "",
                 ServerConfig::Application + "." + ServerConfig::ServerName,
                 "testCoro", 0, _trace_param_, "");
    }
  }
  ...
  static void async_response_testDyeingTrans(tars::TarsCurrentPtr current,
                                             tars::Int32 _ret) {
    size_t _rsp_len_ = 0;
    if (current->getRequestVersion() == TUPVERSION) {
      UniAttribute<tars::BufferWriterVector, tars::BufferReader> tarsAttr;
  ...
  virtual tars::Int32 testHello(tars::Int32 index, const std::string &s,
                                std::string &r,
                                tars::TarsCurrentPtr current) = 0;
  static void async_response_testHello(tars::TarsCurrentPtr current,
                                       tars::Int32 _ret, const std::string &r) {
    size_t _rsp_len_ = 0;
    if (current->getRequestVersion() == TUPVERSION) {
      UniAttribute<tars::BufferWriterVector, tars::BufferReader> tarsAttr;
      tarsAttr.setVersion(current->getRequestVersion());
  ...
  static void async_response_testPid(tars::TarsCurrentPtr current,
                                     tars::Int32 _ret, const std::string &r) {
    size_t _rsp_len_ = 0;
    if (current->getRequestVersion() == TUPVERSION) {
      UniAttribute<tars::BufferWriterVector, tars::BufferReader> tarsAttr;
  ...
  virtual tars::Int32 testSyncTrans(tars::Int32 index, const std::string &s,
                                    std::string &r,
                                    tars::TarsCurrentPtr current) = 0;
  static void async_response_testSyncTrans(tars::TarsCurrentPtr current,
                                           tars::Int32 _ret,
                                           const std::string &r) {
    size_t _rsp_len_ = 0;
    if (current->getRequestVersion() == TUPVERSION) {
  ...
  virtual tars::Int32 testTimeout(tars::Int32 timeout,
                                  tars::TarsCurrentPtr current) = 0;
  static void async_response_testTimeout(tars::TarsCurrentPtr current,
                                         tars::Int32 _ret) {
    size_t _rsp_len_ = 0;
    if (current->getRequestVersion() == TUPVERSION) {
      UniAttribute<tars::BufferWriterVector, tars::BufferReader> tarsAttr;
  ...
  virtual tars::Int32 testTrans(tars::Int32 index, const std::string &s,
                                std::string &r,
                                tars::TarsCurrentPtr current) = 0;
  static void async_response_testTrans(tars::TarsCurrentPtr current,
                                       tars::Int32 _ret, const std::string &r) {
    size_t _rsp_len_ = 0;
    if (current->getRequestVersion() == TUPVERSION) {
      UniAttribute<tars::BufferWriterVector, tars::BufferReader> tarsAttr;
...
public:
  int onDispatch(tars::TarsCurrentPtr _current,
                 std::vector<char> &_sResponseBuffer) {
    static ::std::string __Test__Hello_all[] = {
        "testCoro", "testDyeing",    "testDyeingTrans", "testHello",
        "testPid",  "testSyncTrans", "testTimeout",     "testTrans"};

    std::pair<string *, std::string *> r = equal_range(
        __Test__Hello_all, __Test__Hello_all + 8, _current->getFuncName());
    if (r.first == r.second)
      return tars::TARSSERVERNOFUNCERR;
    ...
    case 0: {
      ...
      if (pSptd && pSptd->_traceCall) {
        std::string_trace_param_;
        int _trace_param_flag_ = pSptd->needTraceParam(
            ServantProxyThreadData::TraceContext::EST_SR, _is.size());
        if (ServantProxyThreadData::TraceContext::ENP_NORMAL ==
            _trace_param_flag_) {
          tars::JsonValueObjPtr _p_ = new tars::JsonValueObj();
          _p_->value["sIn"] = tars::JsonOutput::writeJson(sIn);
        ...
        TARS_TRACE(
            pSptd->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR),
            TRACE_ANNOTATION_SR, "",
            ServerConfig::Application + "." + ServerConfig::ServerName,
            "testCoro", 0, _trace_param_, "");
      }
      ...
      if (_current->isResponse()) {
        ...
        if (pSptd && pSptd->_traceCall) {
          std::string_trace_param_;
          int _trace_param_flag_ = pSptd->needTraceParam(
              ServantProxyThreadData::TraceContext::EST_SS,
          ...
          TARS_TRACE(
              pSptd->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS),
              TRACE_ANNOTATION_SS, "",
              ServerConfig::Application + "." + ServerConfig::ServerName,
              "testCoro", 0, _trace_param_, "");
        }
